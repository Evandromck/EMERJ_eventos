...
<div class="wrapper row3">
  <div id="container">
    ...
    <p class="row5"><strong><span style="font-size:20px">ALTERAÇÃO DE CADASTRO DO PARTICIPANTES</span></strong></p>
                ...
                <table width="100%" class="tabelanew_eventos">
							...
							<tr>
								...
								<td height="30" colspan="4">
                                  <div align="center">
                                    <input type="submit" name="submit" id="submit" value="Alterar Cadastro" onclick=" return validarForm()">
                              </div></td>
							</tr>
						</table>
</table>
