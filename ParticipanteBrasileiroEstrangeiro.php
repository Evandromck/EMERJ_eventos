...
<form method="post" id="form" name="form" action="consultaCadastroBrasileiroEstrangeiro.php">
						<table width="100%" class="tabelanew_eventos">
                            ...
                            <tr>
                              <td width="45%">
                                <input type="text" id="cpf" name="cpf"  class="campo_form" size="40"/>
                              </td>
							...
							<tr>
                              ...
                              <td width="45%">
                                <input type="text" id="email" name="email" class="campo_form" maxlength="50" size="40">
							</td>
                ...
                <table width="100%" class="tabelanew_eventos">
							...
							<tr>
								...
								<td height="30" colspan="4">
                                  <div align="center">
                                    <input type="submit" name="submit" id="submit" value="Cadastrar" onclick=" return validarForm()">
                              </div></td>
							</tr>
						</table>
</table>
