...
<div style="float:left; width:90%;"><input id="tel" name="tel" type="text" class="campo_form"  size="15" /></div></td>
...
-->
					<td>
<input type="text" id="matTj" name="matTj" class="campo_form" size="10" maxlength="12" /></td>
      ...
      <td>&nbsp;</td>
        ...
        <select name="uf" id="uf" class="campo_form">
			...
			<table width="100%" class="tabelanew_eventos">
				...
				<tr>
					<td><input id="email" name="email" type="text"  required class="campo_form" size="35" maxlength="50" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    
					<td><input id="confir_email" name="confir_email" required type="text" class="campo_form" size="35" maxlength="50" /></td>
				</tr>
               </table>
    <!--
			<table width="100%" class="tabelanew_eventos">
