    ...
    <ul class="clear">
      ...
      <li><a class="drop" href="#" title="BIBLIOTECA">BIBLIOTECA</a>
        <ul>
          ...
          <li><a href="http://www.emerj.tjrj.jus.br/magistrados/paginas/pesquisasparamagistrados/pesquisas-para-magistrados.html" title="Pesquisas para Magistrados" target="_blank">Pesquisas para Magistrados</a></li>
        </ul>
      </li>
      ...
      <li><a class="drop" href="#" title="Licita&Ccedil;&Otilde;ES">Licita&Ccedil;&Otilde;ES</a>
        <ul>
          ...
          <li><a href="http://www.emerj.tjrj.jus.br/paginas/licitacao/contratos_convenios_termosemgeral/contratos_convenios_termosemgeral.htm" title="Contratos, Conv&ecirc;nios e Termos em Geral">Contratos, Conv&ecirc;nios e <br>Termos em Geral</a></li>
...
<div class="wrapper row3">
  <div id="container">
    ...
    <div id="sidebar_1" class="sidebar one_quarter first" align="left">
      <aside>
       ...
       <section>
          ...
          <div align="justify">
            <address>
            <p align="justify">Recomendamos que utilize o navegador <strong>Internet Explorer</strong> ou <strong>Google Chrome</strong>. N&atilde;o utilize dispositivos m&oacute;veis e os navegadores Mozilla Firefox e Safari, pois poder&atilde;o surgir erros nas etapas de cadastro e inscri&ccedil;&atilde;o.</p>
            <br>
    ...
    <p class="row5"><strong><span style="font-size:20px">ALTERAÇÃO DE CADASTRO</span></strong></p>
      ...
      -->
<form method="post" id="form" name="form" action="atualizaCadastro.php">
...
<?php
	$cpf = $_SESSION['cpf'];
	$nome = $_SESSION['nome'];
	$fone = $_SESSION['celular'];
	//$profissao = $_SESSION['profissao'];
	$email = $_SESSION['email'];
	$senha = $_SESSION['senha'];
	$sexo = $_SESSION['sexo'];
	$matricula_emerj = $_SESSION['matricula_emerj'];
	$matricula_tj = $_SESSION['matricula_tj'];
	$pais = $_SESSION['pais'];
	$uf = $_SESSION['estado'];
	$auto = $_SESSION['autorizacao'];
...
<!--<option value="" selected>Selecionar</option>
			   ...
			   switch($profissao):
			    case "01": 
				  echo '<option value="01" >ADVOGADO</option>
				  ...
				  break;
				case "02":
			      echo '<option value="02" >DEFENSOR P&Uacute;BLICO</option>
				  ...
				  break;
				case "03":
			      echo '<option value="03" >DESEMBARGADOR</option>
						<option value="01" >ADVOGADO</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
						<option value="06" >JUIZ</option>
				  ...
				  break;
				case "04": 
				  echo '<option value="04">ESTUDANTE</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
						<option value="06" >JUIZ</option>
				  ...
				  break;
				case "05":
			      echo '<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="06" >JUIZ</option>
				  ...
				  break;
				case "06": 
				  echo '<option value="06" >JUIZ</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "07":
			      echo '<option value="07" >MILITAR</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "08": 
				  echo '<option value="08" >OUTRAS PROFISS&Otilde;ES DA AREA DO DIREITO</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "09":
			      echo '<option value="09" >PROFISSIONAL DA AREA MEDICA</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "10": 
				  echo '<option value="10" >PROFISSIONAL DA AREA HUMANAS</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "11":
			      echo '<option value="11">PROFISSIONAL DA AREA CI&Ecirc;NCIAS EXATAS</option>
                        <option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "12": 
				  echo '<option value="12" >PROFISSIONAL DO MAGIST&Eacute;RIO</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "13":
			      echo '<option value="13" >PROMOTOR</option>
						<option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
				  ...
				  break;
				case "14":
			      echo '<option value="14" >OUTRAS PROFISS&Otilde;ES</option>
				        <option value="01" >ADVOGADO</option>
						<option value="03" >DESEMBARGADOR</option>
						<option value="04">ESTUDANTE</option>
						<option value="05" >FUNCION&Aacute;RIO P&Uacute;BLICO</option>
...
<div style="float:left; width:90%;"><input id="tel" value="<?php echo $_SESSION['celular']; ?>" name="tel" type="text" class="campo_form"  size="15" /></div></td>
	...
	<!--				
        ...
        <!--<td width="10%"><span style="font-size:15px;"><div style="width:10px; float:left;" ></td>-->
	               ...
	               <input type="text" id="matEmerj" name="matEmerj" value="<?php if(!empty($_SESSION['matricula_emerj'])): 
								echo $_SESSION['matricula_emerj']; 
						 endif;
					?>" class="campo_form" size="20" maxlength="15"/>
...
<input type="text" id="matTj" name="matTj" value="<?php if(!empty($_SESSION['matricula_tj'])): 
								echo $_SESSION['matricula_tj']; 
						 endif;
					?>" class="campo_form" size="10" maxlength="12" />
		...
		<?php
		 ...
		 ?>
			...
			<table width="100%" class="tabelanew_eventos">
				...
				<tr>
					<td><input id="email" name="email" value="<?php echo $_SESSION['email']; ?>" type="email"  required class="campo_form" size="35" maxlength="50" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
...
<div style="float:left; width:35%;"><input name="telComercial" type="text" class="campo_form"  size="15" maxlength="8" /></div></td>
				...
				<td><span style="font-size:15px;">Confirma&ccedil;&atilde;o da Senha* (M&aacute;ximo 10 caracteres)</span></td>
                <td>&nbsp;</td>
				</tr>
				<tr>
                    <td><input id="senha" name="senha" required type="password" class="campo_form" size="35" maxlength="10" /></td>
                    
                    
                    
                    <td><input id="confir_senha" name="confir_senha" required type="password" class="campo_form" id="txtConfirmaSenha" size="35" maxlength="10" /></td>
